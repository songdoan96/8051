...
#include"..\my_lib\Soft_I2c.h"
#include"..\my_lib\Lcd4.h"
#include"..\my_lib\Rtc_Ds1307.h"
#include"..\my_lib\LunarCalendar.h"
#include"port.h"


unsigned char * code Days[] = {"CN","T2","T3","T4","T5","T6","T7"};

void main()
{
	unsigned char Hour, Minute, Second, Mode=12, Day, Date, Month, Year;
	...
	while(1)
	{
		...
		PCON|=0x01;		 //vdk vao trang thai nghi
	}
